...
def main():
    ...
    if CONFIG.get("use_anti_overfit", False):
        ...
        df_daily, anti_overfit_metadata = integrate_anti_overfit(
            ...
            use_credit_spread_features=CONFIG.get("use_credit_spread_features", True),
            use_yield_curve_features=CONFIG.get("use_yield_curve_features", True),
            use_vol_term_structure_features=CONFIG.get("use_vol_term_structure_features", True),
            use_macro_surprise_features=CONFIG.get("use_macro_surprise_features", True),
            use_cross_asset_momentum=CONFIG.get("use_cross_asset_momentum", True),
            use_skew_kurtosis_features=CONFIG.get("use_skew_kurtosis_features", True),
            use_seasonality_features=CONFIG.get("use_seasonality_features", True),
            use_order_flow_imbalance=CONFIG.get("use_order_flow_imbalance", True),
            use_correlation_regime=CONFIG.get("use_correlation_regime", True),
            use_fama_french=CONFIG.get("use_fama_french", True),
            use_put_call_ratio=CONFIG.get("use_put_call_ratio", True),
            use_multi_horizon=CONFIG.get("use_multi_horizon", True),
            use_earnings_revision=CONFIG.get("use_earnings_revision", True),
            use_short_interest=CONFIG.get("use_short_interest", False),
            use_dollar_index=CONFIG.get("use_dollar_index", True),
            use_institutional_flow=CONFIG.get("use_institutional_flow", False),
            use_google_trends=CONFIG.get("use_google_trends", False),
            use_commodity_signals=CONFIG.get("use_commodity_signals", True),
            use_treasury_auction=CONFIG.get("use_treasury_auction", False),
            use_fed_liquidity=CONFIG.get("use_fed_liquidity", True),
            use_earnings_calendar=CONFIG.get("use_earnings_calendar", True),
            use_analyst_rating=CONFIG.get("use_analyst_rating", True),
            use_expanded_macro=CONFIG.get("use_expanded_macro", True),
            use_vvix=CONFIG.get("use_vvix", True),
            use_sector_rotation=CONFIG.get("use_sector_rotation", True),
            use_fx_carry=CONFIG.get("use_fx_carry", True),
            use_money_market=CONFIG.get("use_money_market", True),
